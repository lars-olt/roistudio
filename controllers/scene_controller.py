...
class SceneController(QObject):
    ...
    scene_found = pyqtSignal(str, object, str, str, object, int)
    ...
    def _on_scene_found(self, scene_id, pixmap, filename, folder_path, seq_id, obs_ix):
        """Caches scene info and forwards signal."""
        self._scene_cache[scene_id] = (folder_path, seq_id, obs_ix)
        self.scene_found.emit(scene_id, pixmap, filename, folder_path, seq_id, obs_ix)
