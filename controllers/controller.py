...
class Controller(QObject):
    ...
    def __init__(self, model, view):
        ...
        # Use _get_config_path() so the config is writable in a frozen bundle
    ...
    def run_algorithm(self):
        """Runs SPARC pipeline on current scene."""
    ...
    def _get_instrument_config(self):
        """Returns instrument config from current load result."""
    ...
    def on_pixel_hover(self, x, y):
        ...
        try:
            ...
            self._view.panel_spectral_view.plot_preview_spectrum_separate(
                nb_wls_sorted, nb_spec_sorted, bayer_wls, bayer_spectrum
            )
